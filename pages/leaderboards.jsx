          ...
          <MDBContainer fluid className="mt-5">
            ...
            <MDBRow>
              <LeaderBoardCard
                ...
                maxRows={10} socialBadges={["likes", "downloads", "favorites"]}
              />
              <LeaderBoardCard
                ...
                maxRows={10} socialBadges={["likes", "favorites", "downloads"]}
              />
              <LeaderBoardCard
                ...
                maxRows={10} socialBadges={["likes", "favorites"]}
              />
              <LeaderBoardCard
              leaderBoardName={"Chart-Toppers"}
                ...
                maxRows={10} socialBadges={["totalRatings","averageRating", "downloads"]}
              />
              <LeaderBoardCard
              leaderBoardName={"Most Decorated"}
                ...
                maxRows={10} socialBadges={["downloads"]}
              />
              <LeaderBoardCard
              leaderBoardName={"Hall of Fame"}
                ...
                maxRows={10} socialBadges={["favorites"]}
              />
            </MDBRow>
            {/* Photos (User's) */}
            <MDBRow></MDBRow>

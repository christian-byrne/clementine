...
function createLeaderboardRanks(ranks) {
  ...
  for (let i = 0; i < ranks.length; i++) {
    ret.push(
      <p className={i === 0 ? "mb-1" : "mb-0 small text-muted text-xs"}>
        {ranks[i]}
      </p>
    );
  }
      ...
      <MDBCardBody>
        ...
        {userData["badges"] && (
          <MDBContainer className="my-2">
            ...
            {/* <!-- Badges Row 2: A-Tier --> */}
            {userData["badges"] && userData["badges"]["tier2"] && (
              <MDBContainer className="d-flex justify-content-center align-items-center mb-3">
            ...
            {/* <!-- Badges Row 3: B-Tier --> */}
            {userData["badges"] && userData["badges"]["tier3"] && (
              <MDBContainer className="d-flex justify-content-center align-items-center mb-3">
            ...
            {/* <!-- Badges Row 4: C-Tier --> */}
            {userData["badges"] && userData["badges"]["tier4"] && (
              <MDBContainer className="d-flex justify-content-center align-items-center mb-3">
            ...
            <MDBContainer className="d-flex justify-content-center align-items-center mb-3">
              {userData["achievements"].map((achievement, index) => (
                <div className="me-3 mb-3 w-25">
                  <img
                    src={process.env.PUBLIC_URL + achievement.src}
                    alt={achievement.alt}
                    class="img-fluid rounded-circle"
